        ...
        implements ConnectorSplitManager
{
    ...
    {
        ElasticsearchTableLayoutHandle layoutHandle = checkType(layout, ElasticsearchTableLayoutHandle.class, "layout");
        ...
        splits.add(new ElasticsearchSplit(connectorId, tableHandle.getSchemaName(), tableHandle.getTableName(), this.elasticsearchClient.getMetadataURI()));
