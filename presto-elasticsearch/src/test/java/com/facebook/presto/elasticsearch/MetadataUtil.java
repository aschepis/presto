...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<ElasticsearchTable> TABLE_CODEC;
    public static final JsonCodec<ElasticsearchColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        TABLE_CODEC = codecFactory.jsonCodec(ElasticsearchTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(ElasticsearchColumnHandle.class);
    }
