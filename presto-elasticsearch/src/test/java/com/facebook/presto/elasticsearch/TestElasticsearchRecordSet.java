...
public class TestElasticsearchRecordSet
{
    ...
    public void testGetColumnTypes()
            throws Exception
    {
        RecordSet recordSet = new ElasticsearchRecordSet(new ElasticsearchSplit("test", "schema", "table", dataUri), ImmutableList.of(
        ...
        recordSet = new ElasticsearchRecordSet(new ElasticsearchSplit("test", "schema", "table", dataUri), ImmutableList.of(
                new ElasticsearchColumnHandle("test", "value", BIGINT, 1),
                new ElasticsearchColumnHandle("test", "text", createUnboundedVarcharType(), 0)));
